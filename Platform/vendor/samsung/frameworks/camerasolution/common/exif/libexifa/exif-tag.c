...
static const struct TagEntry {
	...
	{EXIF_TAG_DATE_TIME_DIGITIZED, "DateTimeDigitized",
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{EXIF_TAG_OFFSET_TIME, "OffsetTime",
	 N_("Time zone for ModifyDate"),
	 N_("To record the offset from UTC of the time of DateTime tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{EXIF_TAG_OFFSET_TIME_ORIGINAL, "OffsetTimeOriginal",
	 N_("Time zone for DateTimeOriginal"),
	 N_("To record the offset from UTC of the time of DateTimeOriginal tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{EXIF_TAG_OFFSET_TIME_DIGITIZED, "OffsetTimeDigitized",
	 N_("Time zone for CreateDate"),
	 N_("To record the offset from UTC of the time of DateTimeDigitized tag."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
