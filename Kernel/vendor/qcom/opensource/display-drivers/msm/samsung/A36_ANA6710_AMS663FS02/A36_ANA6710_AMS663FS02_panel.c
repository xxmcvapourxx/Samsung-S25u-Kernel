...
*/
#include "A36_ANA6710_AMS663FS02_panel.h"
#include "A36_ANA6710_AMS663FS02_mdnie.h"
#include "ss_panel_power.h" // JUN_TEMP
...
void A36_ANA6710_AMS663FS02_FHD_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->h_buf = A36_ANA6710_AMS663FS02_PDF_DATA;
	vdd->h_size = sizeof(A36_ANA6710_AMS663FS02_PDF_DATA);
