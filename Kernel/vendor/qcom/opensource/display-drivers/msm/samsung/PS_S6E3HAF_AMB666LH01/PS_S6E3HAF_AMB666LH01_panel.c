...
*/
#include "PS_S6E3HAF_AMB666LH01_panel.h"
#include "PS_S6E3HAF_AMB666LH01_mdnie.h"
...
void PS_S6E3HAF_AMB666LH01_WQHD_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->h_buf = PS_S6E3HAF_AMB666LH01_PDF_DATA;
	vdd->h_size = sizeof(PS_S6E3HAF_AMB666LH01_PDF_DATA);
