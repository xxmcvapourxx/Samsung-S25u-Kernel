...
/*
TeleCAM5x_Adaptive MIPI 2.0_IMX854_240624.xlsx
SET A : No-Bin (10Bit) (3231.49 / 3142.61)
SET B : 2x2/No-Bin (12Bit) (2785.02 / 2720.34 / 2714.28)
SET C : 4x4 (10Bit) (1857.35 / 1796.72 / 1746.19)
...
/* ========== Mode B =============== */
/*************************************/
struct cam_sensor_i2c_reg_array MIPI_B_2785_REG_ARRAY[] = {
...
static const struct cam_sensor_i2c_reg_setting sensor_imx854_setfile_B_mipi_2785[] = {
    { MIPI_B_2785_REG_ARRAY, ARRAY_SIZE(MIPI_B_2785_REG_ARRAY),
	  CAMERA_SENSOR_I2C_TYPE_WORD, CAMERA_SENSOR_I2C_TYPE_BYTE, 0 }
};
...
static const struct cam_mipi_setting sensor_imx854_setfile_B_mipi_setting[] = {
	{ "2785 Msps", 2785,
	  sensor_imx854_setfile_B_mipi_2785, ARRAY_SIZE(sensor_imx854_setfile_B_mipi_2785) },
	{ "2720 Msps", 2720,
...
const struct cam_mipi_sensor_mode* imx854_get_adaptive_mipi_info(struct cam_sensor_ctrl_t *s_ctrl, struct cam_mipi_info *mipi_info)
{
	CAM_INFO(CAM_SENSOR, "[AM_DBG] datarate : %d", mipi_info[TELE2_CAM].data_rate);

	for (int i = 0; i < ARRAY_SIZE(sensor_imx854_setfile_A_mipi_setting); i++)
	{
		if (mipi_info[TELE2_CAM].data_rate == sensor_imx854_setfile_A_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_imx854_setfile_B_mipi_setting); i++)
	{
		if (mipi_info[TELE2_CAM].data_rate == sensor_imx854_setfile_B_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_imx854_setfile_C_mipi_setting); i++)
	{
		if (mipi_info[TELE2_CAM].data_rate == sensor_imx854_setfile_C_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_imx854_setfile_D_mipi_setting); i++)
	{
		if (mipi_info[TELE2_CAM].data_rate == sensor_imx854_setfile_D_mipi_setting[i].mipi_rate)
		{
...
struct cam_sensor_adaptive_mipi_info imx854_adaptive_mipi_info = {
	.get_adaptive_mipi_info = imx854_get_adaptive_mipi_info,
};
