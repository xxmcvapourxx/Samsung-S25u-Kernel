...
/*
WideCAM_Adaptive_MIPI_2.0_HP2_240624.xlsx
...
const struct cam_mipi_sensor_mode* s5khp2_get_adaptive_mipi_info(struct cam_sensor_ctrl_t *s_ctrl, struct cam_mipi_info *mipi_info)
{
	CAM_INFO(CAM_SENSOR, "[AM_DBG] datarate : %d", mipi_info[WIDE_CAM].data_rate);

	for (int i = 0; i < ARRAY_SIZE(sensor_s5khp2_setfile_A_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5khp2_setfile_A_mipi_setting[i].mipi_rate &&
			s_ctrl->sensor_width > 16000)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_s5khp2_setfile_B_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5khp2_setfile_B_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_s5khp2_setfile_C_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5khp2_setfile_C_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_s5khp2_setfile_D_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5khp2_setfile_D_mipi_setting[i].mipi_rate)
		{
...
struct cam_sensor_adaptive_mipi_info s5khp2_adaptive_mipi_info = {
	.get_adaptive_mipi_info = s5khp2_get_adaptive_mipi_info,
};
