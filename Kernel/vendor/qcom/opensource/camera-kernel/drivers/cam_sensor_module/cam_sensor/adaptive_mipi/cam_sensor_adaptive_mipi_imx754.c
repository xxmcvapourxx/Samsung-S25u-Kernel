...
/*
TeleCAM3x_Adaptive MIPI 2.0_IMX754_240624.xlsx
...
const struct cam_mipi_sensor_mode* imx754_get_adaptive_mipi_info(struct cam_sensor_ctrl_t *s_ctrl, struct cam_mipi_info *mipi_info)
{
	CAM_INFO(CAM_SENSOR, "[AM_DBG] datarate : %d", mipi_info[TELE1_CAM].data_rate);

	for (int i = 0; i < ARRAY_SIZE(sensor_imx754_setfile_A_mipi_setting); i++)
	{
		if (mipi_info[TELE1_CAM].data_rate == sensor_imx754_setfile_A_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_imx754_setfile_B_mipi_setting); i++)
	{
		if (mipi_info[TELE1_CAM].data_rate == sensor_imx754_setfile_B_mipi_setting[i].mipi_rate)
		{
...
struct cam_sensor_adaptive_mipi_info imx754_adaptive_mipi_info = {
	.get_adaptive_mipi_info = imx754_get_adaptive_mipi_info,
};
