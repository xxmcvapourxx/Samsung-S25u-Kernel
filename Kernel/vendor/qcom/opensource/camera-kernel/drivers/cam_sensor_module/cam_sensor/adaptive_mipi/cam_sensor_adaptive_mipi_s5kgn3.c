...
/*
WideCAM_Adaptive MIPI 2.0_GN3_240624.xlsx
...
const struct cam_mipi_sensor_mode* s5kgn3_get_adaptive_mipi_info(struct cam_sensor_ctrl_t *s_ctrl, struct cam_mipi_info *mipi_info)
{
	CAM_INFO(CAM_SENSOR, "[AM_DBG] datarate : %d", mipi_info[WIDE_CAM].data_rate);

	for (int i = 0; i < ARRAY_SIZE(sensor_s5kgn3_setfile_A_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5kgn3_setfile_A_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_s5kgn3_setfile_B_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5kgn3_setfile_B_mipi_setting[i].mipi_rate)
		{
	...
	for (int i = 0; i < ARRAY_SIZE(sensor_s5kgn3_setfile_C_mipi_setting); i++)
	{
		if (mipi_info[WIDE_CAM].data_rate == sensor_s5kgn3_setfile_C_mipi_setting[i].mipi_rate)
		{
...
struct cam_sensor_adaptive_mipi_info s5kgn3_adaptive_mipi_info = {
	.get_adaptive_mipi_info = s5kgn3_get_adaptive_mipi_info,
};
