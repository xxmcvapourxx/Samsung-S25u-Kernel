...
static const struct msm_pingroup parrot_groups[] = {
	...
	[31] = PINGROUP(31, qup0_se0_l3, dp0_hot_plug, NA, gcc_gp2_clk,
			...
			atest_usb0_testdataout02, NA, NA, NA, NA, 0x8D00C, 10),
	[32] = PINGROUP(32, qup0_se5_l0, QSPI0, ddr_bist_stop, NA, NA, NA, NA,
			NA, NA, NA, NA, 0x8D00C, 11),
	...
	[42] = PINGROUP(42, cam_mclk, host2wlan_sol_mira, prng_rosc_test2,
			qdss_gpio_tracedata3, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[43] = PINGROUP(43, cam_mclk, prng_rosc_test3, qdss_gpio_tracedata4,
			NA, NA, NA, NA, NA, NA, NA, NA, 0x8D00C, 15),
	[44] = PINGROUP(44, cci_timer0, cci_async_in0, NA, phase_flag_status25,
			cri_trng_rosc0, qdss_gpio_tracedata11, NA, NA, NA, NA, NA, 0x8D010, 0),
	[45] = PINGROUP(45, cci_timer1, NA, gcc_gp1_clk, cri_trng_rosc1,
			qdss_gpio_tracedata12, NA, NA, NA, NA, NA, NA, 0x8D010, 1),
	[46] = PINGROUP(46, cci_timer2, dbg_out_clk, cri_trng_rosc,
			qdss_gpio_tracedata13, NA, NA, NA, NA, NA, NA, NA, 0x8D010, 2),
	[47] = PINGROUP(47, cci_timer3, NA, phase_flag_status17,
			atest_char_status0, NA, NA, NA, NA, NA, NA, NA, 0x8D010, 3),
	[48] = PINGROUP(48, mdp_vsync_s, mdp_vsync2_out, mdp_vsync3_out, NA,
			phase_flag_status29, atest_char_status1, NA, NA, NA, NA, NA, 0x8D010, 4),
	...
	[64] = PINGROUP(64, NA, tmess_prng_rosc2, NA, ddr_pxi1_test, NA, NA,
			NA, NA, NA, NA, NA, 0x8D010, 11),
	[65] = PINGROUP(65, jitter_bist_ref, tmess_prng_rosc3, NA,
			ddr_pxi1_test, NA, NA, NA, NA, NA, NA, NA, 0x8D010, 12),
	[66] = PINGROUP(66, wlan2_adc_dtest1, atest_usb0_testdataout00, NA, NA,
			NA, NA, NA, NA, NA, NA, NA, 0x8D010, 13),
	[67] = PINGROUP(67, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D010, 14),
	[68] = PINGROUP(68, uim0_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[69] = PINGROUP(69, uim0_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[70] = PINGROUP(70, uim0_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[71] = PINGROUP(71, uim0_present, NA, phase_flag_status24,
			atest_char_start, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 1),
	[72] = PINGROUP(72, uim1_data, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 2),
	[73] = PINGROUP(73, uim1_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[74] = PINGROUP(74, uim1_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, uim1_present, NA, phase_flag_status18,
			tb_trig_sdc2, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 3),
	[76] = PINGROUP(76, NA, NA, NA, audio_ref_clk, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 4),
	[77] = PINGROUP(77, NA, NA, pll_clk_aux, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[78] = PINGROUP(78, NA, NA, NA, pll_bist_sync, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 5),
	[79] = PINGROUP(79, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[80] = PINGROUP(80, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 6),
	[81] = PINGROUP(81, NA, NA, NA, phase_flag_status8, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[82] = PINGROUP(82, NA, NA, NA, phase_flag_status9, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 7),
	[83] = PINGROUP(83, NA, NA, NA, phase_flag_status0, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[86] = PINGROUP(86, NA, nav_gpio2, NA, phase_flag_status1, NA, NA, NA,
			NA, NA, NA, NA, 0x8D004, 9),
	[87] = PINGROUP(87, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[88] = PINGROUP(88, nav_gpio0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D018, 3),
	[89] = PINGROUP(89, nav_gpio1, vfr_1, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D018, 4),
	[90] = PINGROUP(90, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[91] = PINGROUP(91, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D018, 5),
	[92] = PINGROUP(92, qlink0_request, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D018, 6),
	[93] = PINGROUP(93, qlink0_enable, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[94] = PINGROUP(94, qlink0_wmss_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[95] = PINGROUP(95, qlink1_request, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D018, 7),
	[96] = PINGROUP(96, qlink1_enable, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[97] = PINGROUP(97, qlink1_wmss_reset, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[98] = PINGROUP(98, i2s0_sck, qup1_se2_l4, tsense_pwm1_out,
			tsense_pwm2_out, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 10),
	[99] = PINGROUP(99, mdp_vsync_p, i2s0_ws, mdp_vsync0_out,
			mdp_vsync1_out, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 11),
	[100] = PINGROUP(100, usb0_phy_ps, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D010, 15),
	[101] = PINGROUP(101, i2s0_data0, NA, phase_flag_status20, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0x8D004, 12),
	[102] = PINGROUP(102, NA, phase_flag_status31, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0x8D014, 0),
	[103] = PINGROUP(103, mdp_vsync_p, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D014, 1),
	[104] = PINGROUP(104, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D014, 2),
	[105] = PINGROUP(105, usb0_hs_ac, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D014, 3),
	[106] = PINGROUP(106, vfr_0_mirb, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[107] = PINGROUP(107, NA, phase_flag_status19, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0x8D004, 13),
	[108] = PINGROUP(108, sd_write_protect, NA, phase_flag_status15, NA,
			 NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[109] = PINGROUP(109, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D014, 4),
	[110] = PINGROUP(110, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[111] = PINGROUP(111, i2s0_data1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D004, 14),
	[112] = PINGROUP(112, host2wlan_sol_mirb, dp0_hot_plug, NA, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0x8D018, 8),
	[113] = PINGROUP(113, PCIE0_CLK_REQ, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x8D018, 9),
	[114] = PINGROUP(114, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[115] = PINGROUP(115, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x8D004, 15),
	[116] = PINGROUP(116, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[117] = PINGROUP(117, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[118] = PINGROUP(118, NA, qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA, NA, egpio,
			 0x8D008, 0),
	[119] = PINGROUP(119, qdss_cti_trig0, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	...
	[125] = PINGROUP(125, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x8D008, 1),
	[126] = PINGROUP(126, qdss_gpio_tracedata7, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, egpio, 0, -1),
	[127] = PINGROUP(127, qdss_gpio_tracedata8, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, egpio, 0, -1),
	[128] = PINGROUP(128, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x8D008, 2),
	[129] = PINGROUP(129, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[130] = PINGROUP(130, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x8D008, 3),
	...
	[138] = PINGROUP(138, NA, phase_flag_status22, qdss_gpio_tracedata15,
			 NA, NA, NA, NA, NA, NA, NA, egpio, 0x8D008, 6),
	[139] = PINGROUP(139, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0, -1),
	[140] = PINGROUP(140, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, egpio, 0x8D008, 7),
