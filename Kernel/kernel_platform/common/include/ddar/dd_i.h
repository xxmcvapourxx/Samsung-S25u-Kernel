...
enum dd_crypto_direction_t {
	DD_ENCRYPT = 0,
	DD_DECRYPT,
};

enum dd_request_code_t {
	DD_REQ_INVALID = 0,
	DD_REQ_PREPARE = 1,
	DD_REQ_CRYPTO_BIO = 2,
...
#define DD_IOCTL_GET_LOCK_STATE			_IOR('L', 0x02, unsigned int)
/* } KNOX_SUPPORT_DAR_DUAL_DO */
