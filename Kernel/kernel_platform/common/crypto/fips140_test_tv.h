...
const struct hash_testvec sha384_tv_template[] = {
		...
		.ptext = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
		.plen	= 112,
		...
		.ptext = "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz",
		.plen	= 104,
...
const struct hash_testvec hmac_sha1_tv_template[] = {
	{
		...
		.key	= "\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa"
			...
			"\xaa\xaa",
		.klen	= 80,
		.ptext = "Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data",
		.plen	= 73,
...
const struct hash_testvec hmac_sha256_tv_template[] = {
	{
		...
		.key	= "\x01\x02\x03\x04\x05\x06\x07\x08"
			...
			"\x19\x1a\x1b\x1c\x1d\x1e\x1f\x20",
		.klen	= 32,
		.ptext = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopqabcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
		.plen	= 112,
...
const struct hash_testvec hmac_sha384_tv_template[] = {
	{
		...
		.key	= "\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa"
			...
			"\xaa\xaa\xaa",
		.klen	= 131,
		.ptext = "This is a test using a larger than block-size key and a larger than block-size data. The key needs to be hashed before being used by the HMAC algorithm.",
		.plen	= 152,
